  ...
  <section class="KimiHero">
    ...
    <div class="KimiHero__inner">
      ...
      <h1 class="KimiHero__title">
        {{ copy.titleLead }}&nbsp;<span class="KimiHero__accent">{{ copy.titleAccent }}</span
        >{{ copy.titleTail }}
      </h1>
...
.KimiHero__halo {
  ...
  background:
    ...
    radial-gradient(closest-side, rgba(129, 196, 255, 0.2) 30%, transparent 75%);
  filter: blur(40px);
  pointer-events: none;
  z-index: 0;
  opacity: 0.55;
...
:global(.dark) .KimiHero__halo {
  ...
  background:
    ...
    radial-gradient(closest-side, rgba(129, 196, 255, 0.3) 30%, transparent 75%);
}
