...
const config = withMermaid(
  defineConfig({
        ...
        themeConfig: {
          ...
          sidebar: {
            ...
            '/zh/customization/': [
              {
                ...
                items: [
                  ...
                  { text: '数据源', link: '/zh/customization/datasource' },
            ...
            '/zh/release-notes/': [
              {
                text: '发布说明',
                items: [{ text: '变更记录', link: '/zh/release-notes/changelog' }],
              },
            ],
          },
        },
        ...
        themeConfig: {
          ...
          sidebar: {
            ...
            '/en/customization/': [
              {
                ...
                items: [
                  ...
                  { text: 'Datasource', link: '/en/customization/datasource' },
            ...
            '/en/release-notes/': [
              {
                text: 'Release Notes',
                items: [{ text: 'Changelog', link: '/en/release-notes/changelog' }],
              },
            ],
          },
        },
    ...
    themeConfig: {
      ...
      socialLinks: [{ icon: 'github', link: 'https://github.com/MoonshotAI/kimi-code' }],
    },
