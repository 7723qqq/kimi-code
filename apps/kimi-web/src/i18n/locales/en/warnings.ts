export default {
  ...
  daemonNetworkMessage:
    'Web did not receive a response from the local service. Check that Kimi daemon is still running, or refresh the page.',
  ...
  sessionSnapshotMessage:
    'Web could not load the current conversation. Check that Kimi daemon is still running, or refresh the page.',
