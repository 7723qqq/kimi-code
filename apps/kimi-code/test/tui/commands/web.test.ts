...
const mocks = vi.hoisted(() => ({
  ...
  t: (key: string, params?: Record<string, string | number>) => {
    const translations: Record<string, string> = {
      'tui.statusMessages.serverReadyBanner': 'Kimi server ready',
      'tui.statusMessages.serverReadyLocalUi': 'Local web UI is available from this machine.',
      'tui.statusMessages.serverAccessLocal': 'Local:    ',
    };
