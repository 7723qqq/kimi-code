 ...
 *
 * Mirrors `tui/reverse-rpc/types.ts`. These types are the contract between
 * the UI layer and reverse RPC controllers, not SDK event payloads. Approval
 * and question adapters convert core payloads into these shapes for panel
