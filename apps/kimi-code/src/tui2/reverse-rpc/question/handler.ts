 ...
 *
 * Mirrors `tui/reverse-rpc/question/handler.ts`. Adapts a core
 * `QuestionRequest` into view data, shows the dialog via the controller, and
 * maps the user's answers back into the SDK result shape.
 *
