/**
 * TUI2 slash-command registry — builtin commands + argument completion.
 *
 * Mirrors `tui/commands/registry.ts` — pure logic, no rendering dependency.
 *
 * Status: REAL (tui2). Mirrors `tui/commands/registry.ts`.
 */
