/**
 * TUI2 banner display state — persisted "shown" records for tips banners.
 *
 * Mirrors `tui/banner/state.ts` with imports converged onto the tui2 tree.
 * Pure logic — no rendering dependency.
 *
 * Status: REAL (tui2). Mirrors `tui/banner/state.ts`.
 */
