/**
 * Terminal control sequences and probe constants shared across the v2 TUI.
 *
 * Mirrors `tui/constant/terminal.ts` — these are framework-agnostic byte
 * sequences consumed by the theme/background detection and OSC handling,
 * independent of the pi-tui vs opentui rendering model.
 *
