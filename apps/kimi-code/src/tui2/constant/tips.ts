/**
 * Toolbar tips for the v2 TUI.
 *
 * Mirrors `tui/constant/tips.ts`. Pure i18n-driven data — framework-agnostic.
 *
 ...
 * locale that is active when the footer renders, not the English default
 * captured at import time before tui.toml's locale is applied.
 */
