/**
 * OSC 11 background reply parsing.
 *
 * Mirrors `tui/theme/terminal-background.ts`. Framework-agnostic parsing of
 * the terminal's background-colour reply.
 *
 * Status: REAL (tui2). Self-contained; no v1 re-export.
 */

import { OSC11_RESPONSE } from '#/tui2/constant/terminal';
