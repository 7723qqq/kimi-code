/**
 * TUI2 file mention provider.
 *
 * Mirrors `tui/components/editor/file-mention-provider.ts` (framework-agnostic
 * autocomplete wiring over pi-tui; no rendering dependency). Self-contained.
 *
 * Status: REAL (tui2). No v1 re-export.
 */
