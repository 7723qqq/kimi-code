 ...
 *
 * Mirrors `tui/components/media/code-highlight.ts` — wraps `cli-highlight`
 * with the shared theme so the syntax tokens match across the editor and
 * the approval viewer.
 *
 * Status: REAL (tui2). Mirrors v1 utility.
 */
