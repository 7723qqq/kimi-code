/**
 * TUI2 diff preview — plain-ANSI diff rendering.
 *
 * Mirrors `tui/components/media/diff-preview.ts` (framework-agnostic; no
 * pi-tui component dependency), but resolves styles from the tui2 theme.
 *
