/**
 * TUI2 pure formatting helpers for the tool-call module.
 *
 * Mirrors `tui/components/messages/tool-call/formatters.ts` with imports
 * converged onto the tui2 tree. Pure formatting — no rendering, no
 * pi-tui dependency.
 *
