/**
 * TUI2 AgentSwarm progress estimator — pure state machine.
 *
 * Mirrors `tui/components/messages/agent-swarm-progress-estimator.ts`
 * verbatim: framework-free progress estimation for AgentSwarm members
 * (decayed tool-call rates, completed-sample priors, bounded catch-up
 * easing). No rendering, no dependencies.
 *
