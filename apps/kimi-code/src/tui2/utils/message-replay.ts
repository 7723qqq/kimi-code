/**
 * TUI2 message replay helpers — resume replay → transcript entries.
 *
 * Mirrors `tui/utils/message-replay.ts` with imports converged onto the tui2
 * tree. Pure logic — no pi-tui dependency.
 *
 * Status: REAL (tui2). Mirrors `tui/utils/message-replay.ts`.
 */
