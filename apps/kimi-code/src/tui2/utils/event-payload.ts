/**
 * Stream event payload helpers: build the streaming-args preview, parse tool
 * arguments, and render SDK errors / provider-filtered responses into the
 * strings shown by message components.
 *
