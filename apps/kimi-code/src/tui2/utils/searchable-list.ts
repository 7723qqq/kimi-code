/**
 * TUI2 cursor + fuzzy-search + paging state machine shared by list pickers.
 *
 * Mirrors `tui/utils/searchable-list.ts` with imports converged onto the
 * tui2 tree. Pure logic, no rendering.
 *
