...
export const NO_ACTIVE_SESSION_MESSAGE = t('tui.chrome.hints.noActiveSession');
export const CTRL_D_HINT = t('tui.chrome.hints.ctrlDExit');
export const CTRL_C_HINT = t('tui.chrome.hints.ctrlCExit');
export const MAIN_AGENT_ID = 'main';
export const OAUTH_LOGIN_REQUIRED_STARTUP_NOTICE = t('tui.chrome.hints.oauthLoginExpired');
