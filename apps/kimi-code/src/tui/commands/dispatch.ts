...
// ---------------------------------------------------------------------------
// Host interface — declared in `./types` so handler modules depend on the
// contract rather than on this dispatcher. Re-exported here for consumers that
// still import it from `dispatch`.
// ---------------------------------------------------------------------------

export type { SlashCommandHost };
