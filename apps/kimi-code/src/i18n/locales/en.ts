export default {
  ...
  cli: {
    ...
    commandDescriptions: {
      ...
      web: 'Run the local Kimi server and open the web UI.',
  ...
  tui: {
    chrome: {
      footer: {
        ...
        llmTime: 'LLM {{time}}',
        toolTime: 'tools {{time}}',
        firstTokenAvg: 'first token avg {{time}}',
        inputOutput: 'in {{input}} tok · out {{output}} tok',
        statusActive: 'active',
        statusPaused: 'paused',
    ...
    slashCommands: {
      ...
      workflowHelp: {
        usage: 'Usage:',
        list: '  /workflow list              — list available workflows',
        run: '  /workflow <name> [args...]  — run a workflow by name',
        status: '  /workflow status <runId>    — check status of a workflow run',
        cancel: '  /workflow cancel <runId>    — cancel a running workflow',
        example: 'Example:',
      },
    ...
    dialogs: {
      ...
      msys2Prompt: {
        title: 'MSYS2 not detected',
        hint: 'MSYS2 provides a full Linux command-line environment on Windows. Install it now and switch the shell?',
        install: 'Install MSYS2',
        installDescription:
          'Installs via winget and switches the shell to MSYS2 bash (restart required).',
        skip: 'Skip',
        skipDescription: 'Continue with the current shell. You can install MSYS2 later.',
        installing: 'Installing MSYS2…',
        installSuccess: 'MSYS2 installed',
        installFailed: 'MSYS2 install failed',
        restartHint: 'Restart kimi-code to use the MSYS2 shell.',
      ...
      modelSelector: {
        ...
        secondaryTitle: ' Select a secondary model (subagents)',
        searchHint: '(type to search)',
        searchLabel: 'Search: ',
      ...
      astronSettings: {
        ...
        hint: '↑↓ navigate · Enter edit/toggle · Ctrl+S save · Esc back',
        stream: 'Stream output',
        temperature: 'Temperature',
        maxTokens: 'Max tokens',
        searchDisable: 'Disable web search',
        on: 'ON',
        off: 'OFF',
        saved: 'Astron settings saved',
      ...
      trustPrompt: {
        ...
        navHint: ' ↑↓ navigate · Enter select · Esc exit',
        trustLabel: 'Trust this folder',
        trustDesc: 'Enable project MCP servers. Remembered for this folder.',
        distrustLabel: "Don't trust",
        distrustDesc: 'Exit Kimi Code. Asked again next launch.',
        notice:
        ...
        projectMcpTargets: 'Project MCP targets:',
      },
      cacheHint: {
        navHint: '↑↓ navigate · Enter select · Esc cancel',
        title: 'This session has been idle for {{idle}} and is ~{{tokens}} tokens.',
        expired: 'Cache expired — the next message re-sends the entire history at full price.',
        compactLabel: 'Compact and continue',
        compactDesc: 'one-time compact cost · cheapest way to keep this topic',
        newLabel: 'Start a new session',
        newDesc: 'zero context cost · best for a new task',
        continueLabel: 'Continue as-is',
        continueDesc: 'full history kept · highest cost per turn',
        neverLabel: "Don't ask me again",
      },
      providerManager: {
        title: 'Providers',
      ...
      whichKey: {
        title: ' Keybindings ',
        cancelHint: '· Esc / Enter / q to close',
        searchLabel: 'Search: ',
        noMatches: 'No matching commands',
        leaderSection: 'Leader (Ctrl-X)',
        shortcutsSection: 'Shortcuts',
        leaderHint: 'Press Ctrl-X then a key',
        actions: {
          ...
          sidebar: 'Toggle activity pane',
          theme: 'Select theme',
          agent: 'Team / agents',
          help: 'Help',
          navigate: 'Navigate messages',
          agentPane: 'Toggle agent panel',
          review: 'Toggle diff review',
        },
        shortcuts: {
          ctrlD: 'Exit (on empty input)',
          ctrlC: 'Interrupt / clear input',
          ctrlG: 'Edit in external editor',
          ctrlO: 'Toggle tool output',
          ctrlS: 'Steer / send queued',
          ctrlB: 'Detach background task',
          ctrlT: 'Toggle todo expand',
          shiftTab: 'Toggle plan mode',
          undo: 'Undo',
          escape: 'Cancel / dismiss',
          whichKey: 'Show keybindings',
          newLine: 'Insert newline',
          transcriptNav: 'Navigate messages (j/k, Enter, Esc)',
          agentPane: 'Toggle agent panel',
          review: 'Toggle diff review',
        },
      },
    ...
    statusMessages: {
      ...
      retryingStepAttempt: 'Retrying ({{attempt}}/{{maxAttempts}}) — {{errorName}}',
      ...
      cacheCompactFailed: 'Compaction failed: {{error}}',
      cacheCompactNotStarted: 'Compaction did not start in time — your input was restored.',
      ...
      pluginsQuotaNote: 'Note: This plugin consumes your quota.',
      // commands/add-dir.ts
      ...
      knownThirdPartyProvider: 'Known third-party provider',
      customRegistryOption: 'Custom registry (api.json)',
      catalogLoaded: 'Catalog loaded.',
      aborted: 'Aborted.',
      catalogFromBuiltIn: 'Catalog loaded from built-in snapshot (models.dev unreachable).',
      catalogFailedToLoad: 'Failed to load catalog.',
      catalogNoSupportedProviders: 'Catalog has no supported providers.',
      importedOneProvider: 'Imported 1 provider.',
      importedProviders: 'Imported {{count}} providers.',
      registryNoProviders: 'Registry had no providers.',
      addProviderFailed: 'Failed to add provider: {{error}}',
      removeProviderFailedGeneric: 'Failed to remove provider: {{error}}',
      removeProviderFailed: 'Failed to remove provider "{{providerId}}": {{error}}',
      fetchingCatalog: 'Fetching catalog from {{url}}…',
      catalogFetchFailed: 'Failed to fetch catalog{{hint}}: {{error}}',
      ...
      failedToApplyRegistry: 'Failed to apply registry: {{error}}',
      providerCatalogUnsupportedProtocol:
        'Provider "{{providerId}}" declares protocol "{{type}}" in the catalog, which this client version does not support.',
      ...
      providerCatalogEmptyBaseUrl: '--base-url cannot be empty.',
      providerCatalogPlaceholderBaseUrl:
    ...
    messages: {
      ...
      configSwitchCachedWarningTokens:
        'Note: This switch invalidates the existing prompt cache — about {{tokens}} tokens will be reprocessed. Use /new to avoid extra token costs.',
    ...
    approvalPanel: {
      shellCwd: 'cwd: {{dir}}',
      shellDangerous: 'Dangerous: {{reason}}',
      shellPrompt: '$ ',
      shellContinuation: '· ',
      searchPrefix: 'search',
    ...
    migration: {
      ...
      retryHint: ' You can retry later by running "kimi migrate".',
      ...
      sessionsFailed: '  ⚠ {{count}} sessions failed to migrate',
      sessionsSkipped: '  ⚠ {{count}} sessions skipped (target already occupied)',
      emptySessionsSkipped: '  {{count}} empty sessions skipped',
      contains: '     contains: {{items}}',
      stepLabelConfig: 'Config',
      stepLabelMcp: 'MCP',
      stepLabelReplHistory: 'REPL history',
      stepLabelSessions: 'Sessions',
      progressTitle: ' Migrating from kimi-cli',
      progressTranslating: 'Translating sessions…  {{done}} / {{total}}',
      title: ' Migrate from kimi-cli',
      foundExisting: ' Found an existing kimi-cli installation:',
      ask1Title: 'Migrate this data to kimi-code?',
      migrateNow: 'Migrate now',
      askLater: 'Ask me later',
      neverAgain: 'Never ask again',
      ask2Title: 'Migrate chat sessions too? (they are bulky and slower)',
      configOnly: 'Config only',
      configPlusSessions: 'Config + {{count}} sessions',
      configPlusAllSessions: 'Config + all sessions',
      navHintAsk: ' ↑/↓ move · ⏎ select · esc {{action}}',
      badgeImported: '[imported]',
    },
    codingPlan: {
      title: ' Coding Plan Config',
      navHint: ' ↑↓ select field · type to edit · Enter save · Esc cancel',
      invalidValue: 'Invalid value for "{{key}}": {{raw}}',
      fieldProtocol: 'Protocol (openai/anthropic/response)',
      fieldStream: 'Streaming (true/false)',
      fieldTemperature: 'Temperature (0.0-2.0)',
      fieldMaxTokens: 'Max tokens',
      fieldEnableThinking: 'Thinking (true/false)',
      fieldSearchDisable: 'Disable search (true/false)',
      fieldShowRefLabel: 'Show sources (true/false)',
