export default {
  ...
  engine: {
    ...
    tools: {
      ...
      webSearch: {
        ...
        sogouHttpFailed: 'Search failed: Sogou search returned HTTP {{status}}',
      },
      switchEngine: {
        unknown: 'Unknown search engine: {{name}}. Available: bing, ddg, sogou.',
  ...
  tui: {
    ...
    slashCommands: {
      ...
      search: 'Switch the web search engine (bing, ddg, or sogou)',
    ...
    messages: {
      ...
      configTuiModeUnchanged: 'TUI mode already {{mode}}.',
      configTuiModeSaveFailed: 'Failed to save TUI mode: {{error}}',
      configTuiModeSet: 'TUI mode set to {{mode}}.',
