export default {
  ...
  tui: {
    ...
    statusMessages: {
      ...
      webVersion: 'version {{hostVersion}} · id {{id}}',
      webSessionLabel: 'Session:  ',
      ...
      serverTableHeaderId: 'ID',
      serverTableHeaderConnected: 'CONNECTED',
      serverTableHeaderRemote: 'REMOTE',
      serverTableHeaderUserAgent: 'USER_AGENT',
      serverTableHeaderSessions: 'SESSIONS',
      serverTableHeaderHello: 'HELLO',
      ...
      catalogAborted: 'Catalog load aborted.',
      aborted: 'Aborted.',
    ...
    messages: {
      ...
      toolCall: {
        ...
        planApprovedWith: 'Approved: {{option}}',
        verbUsed: 'Used',
      ...
      usagePanel: {
        ...
        input: 'input',
        output: 'output',
        noPlanUsageData: 'No usage data available.',
      },
