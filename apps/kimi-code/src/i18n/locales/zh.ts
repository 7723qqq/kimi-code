...
export default {
  ...
  tui: {
    ...
    statusMessages: {
      ...
      cannotSwitchModelsWhileStreaming: '无法在流式传输时切换模型——请先按 Esc 或 Ctrl-C。',
      ...
      webVersion: '版本 {{hostVersion}} · id {{id}}',
      webSessionLabel: '会话：  ',
      ...
      serverReuseNoticeTitle: '服务器已在运行',
      ...
      serverTableHeaderConnected: '已连接',
      serverTableHeaderRemote: '远程',
      serverTableHeaderUserAgent: '用户代理',
      serverTableHeaderSessions: '会话',
    ...
    migration: {
      failed: ' 迁移失败',
      reason: ' 原因：{{reason}}',
      retryHint: ' 你可以稍后通过运行 "kimi migrate" 重试。',
      continueHint: ' ⏎ 继续使用 kimi-code',
      complete: ' 迁移完成',
      skipped: '  无需迁移。',
      ...
      configConflicts: '  ⚠ {{count}} 处配置冲突保留原设置：{{keys}}',
      configParseError: '  ⚠ config.toml 无法解析 —— 请查看 config.migrated-from-kimi-cli.toml',
      tuiConflict: '  ⚠ tui.toml 冲突 —— 请查看 tui.migrated-from-kimi-cli.toml',
      mcpUnreadable: '  ⚠ mcp.json 无法读取 —— 请查看 mcp.migrated-from-kimi-cli.json',
      mcpNeedsAuth: '  ⚠ {{count}} 个 MCP 服务器需要重新认证',
      sessionsFailed: '  ⚠ {{count}} 个会话迁移失败',
      sessionsSkipped: '  ⚠ {{count}} 个会话已跳过（目标位置已被占用）',
      emptySessionsSkipped: '  {{count}} 个空会话已跳过',
      contains: '     包含：{{items}}',
      stepLabelConfig: '配置',
      stepLabelMcp: 'MCP',
      stepLabelReplHistory: 'REPL 历史',
      stepLabelSessions: '会话',
      progressTitle: ' 从 kimi-cli 迁移中',
      progressTranslating: '正在转换会话…  {{done}} / {{total}}',
      title: ' 从 kimi-cli 迁移',
      foundExisting: ' 检测到现有 kimi-cli 安装：',
      ask1Title: '将此数据迁移到 kimi-code？',
      migrateNow: '立即迁移',
      askLater: '稍后再说',
      neverAgain: '不再询问',
      ask2Title: '也迁移聊天会话？（体积较大，迁移较慢）',
      configOnly: '仅配置',
      configPlusSessions: '配置 + {{count}} 个会话',
      configPlusAllSessions: '配置 + 全部会话',
      navHintAsk: ' ↑/↓ 移动 · ⏎ 选择 · esc {{action}}',
      badgeImported: '[已导入]',
    },
    codingPlan: {
