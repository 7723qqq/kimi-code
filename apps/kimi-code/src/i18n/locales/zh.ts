...
export default {
  ...
  tui: {
    ...
    dialogs: {
      ...
      whichKey: {
        title: ' 快捷键 ',
        cancelHint: '· Esc / Enter / q 关闭',
        searchLabel: '搜索: ',
        noMatches: '无匹配命令',
        leaderSection: 'Leader（Ctrl-X）',
        shortcutsSection: '快捷键',
        leaderHint: '按 Ctrl-X 后再按一个键',
        actions: {
          externalEditor: '在外部编辑器中编辑',
          model: '选择模型',
          sessions: '切换会话',
          newSession: '新建会话',
          compact: '压缩上下文',
        ...
        shortcuts: {
          ...
          whichKey: '显示快捷键',
          newLine: '插入换行',
          transcriptNav: '消息导航（j/k、Enter、Esc）',
          agentPane: '切换智能体面板',
          review: '切换 Diff 审查',
        },
      },
    ...
    messages: {
      ...
      agentSwarmProgress: {
        ...
        membersCount: '{{completed}}/{{total}} 智能体',
