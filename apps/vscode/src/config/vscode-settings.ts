...
const EXTENSION_VERSION =
  typeof __EXTENSION_VERSION__ !== 'undefined' ? __EXTENSION_VERSION__ : '0.0.0';
 ...
 * the legacy v1 engine was removed and the default engine is now the native Rust
 * engine (createKimiHarnessNative). When this flag is truthy, it falls back to
 * the legacy v2 engine (createKimiHarnessV2).
 */
