        ...
        >
          <div className="inline-flex items-center gap-2">
            ...
            {isStreaming && (
              <IconLoader3
                className={cn(
                  'text-zinc-400 ml-auto animate-spin',
  ...
  return (
    <div className="rounded-lg border border-zinc-200/50 bg-zinc-50/30 dark:border-zinc-800/50 dark:bg-zinc-900/10 overflow-hidden">
      <button
        ...
        className={cn(
          'w-full flex items-center gap-2 hover:bg-zinc-100/50 dark:hover:bg-zinc-800/20 transition-colors',
      ...
      >
        <div className="inline-flex items-center gap-2">
          ...
          {isStreaming && (
            <IconLoader3
              className={cn('text-zinc-400 ml-auto animate-spin', compact ? 'size-3' : 'size-3.5')}
            />
          )}
        </div>
        <IconChevronDown
          className={cn(
            'text-zinc-400 ml-auto transition-transform',
            compact ? 'size-3' : 'size-3.5',
            expanded && 'rotate-180',
          )}
        />
      ...
      {expanded && content && (
        <Markdown
          ...
          className={cn(
            ...
            compact ? 'py-2 px-2 text-[0.75rem]' : 'py-3 px-2 pl-3.5 text-xs',
          )}
