...
> **历史快照（2026-08-11，G-7 收口）**：本文档是迁移过程中的文件跟踪清单，其中"🔄 待迁移"项在 G-7 完成后已全部落地或退役（阶段 A–F + G 系列完成，见 `CODEX_MIGRATION_PLAN.md`）。当前状态请以 `CODEX_MIGRATION_PLAN.md` 与根 `AGENTS.md` 为准，勿将本文档的标记当作实时待办。
