 ...
 * reach this layer, so `errors` never imports a business domain.
 *
 * Shared infrastructure: moved from agent-core-v2's `_base/errors`; the
 * engine re-exports it unchanged.
 */
