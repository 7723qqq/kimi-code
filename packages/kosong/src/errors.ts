import { Error2, type Error2Options } from './errors/errors';

import type { FinishReason } from './provider';

/**
 * The provider error taxonomy — the single authority on error classification
 * for the LLM wire layer.
 *
 ...
 * by the engine's `kosong/protocol/errors.ts` (`ProtocolErrors`).
 *
