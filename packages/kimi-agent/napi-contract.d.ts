 ...
 */
export declare function backgroundTaskStop(id: string, reason?: string | undefined | null): object
 ...
 */
export interface JsWebServiceConfig {
  baseUrl: string
  apiKey?: string
  customHeaders?: Record<string, string>
}
 ...
 */
export declare function sessionBtwCancel(agentId: string): boolean
 ...
 */
export declare function sessionStartBtw(sessionId: string): object
