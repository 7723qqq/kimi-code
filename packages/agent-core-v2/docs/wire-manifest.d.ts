...
//   context.apply_compaction           contextMemory, microCompaction, plan, task.notificationDelivery  src/agent/contextMemory/contextEvents.ts
//   context.clear                      contextMemory, microCompaction, plan, task.notificationDelivery  src/agent/contextMemory/contextEvents.ts
...
/**
 * states: contextMemory, microCompaction, plan, task.notificationDelivery · blobs: contextMemory
 * owner: src/agent/contextMemory/contextEvents.ts
